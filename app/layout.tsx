...
export const metadata: Metadata = {
  ...
  description: 'A private, evidence-first preflight for objectively incorrect Indian eChallans.',
  applicationName: 'Challan Jaanch',
  openGraph: {
    type: 'website',
    title: 'Challan Jaanch — See the mismatch. Show the proof.',
    description: 'Evidence preflight for objectively incorrect eChallans.',
