...
export function HowItWorksDrawer({ open, onClose, language = 'en' }: { open: boolean; onClose: () => void; language?: Language }) {
  ...
  const journeySteps: Array<[string, string, string]> = [
    ...
    ['05', t(language, 'Prepare a citizen packet', 'नागरिक पैकेट तैयार करें'), t(language, 'Only supported, confirmed claims enter the PDF, JSON manifest or share-safe text brief. The app then hands off to the separate official portal.', 'सिर्फ़ प्रमाणित और पुष्ट दावे ही PDF, JSON मेनिफ़ेस्ट या सुरक्षित पाठ-सार में जाते हैं। इसके बाद ऐप आपको अलग आधिकारिक पोर्टल पर भेज देता है।')],
  ];
