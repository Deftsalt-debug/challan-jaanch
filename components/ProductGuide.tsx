...
export function HowItWorksDrawer({ open, onClose, language = 'en' }: { open: boolean; onClose: () => void; language?: Language }) {
  ...
  const journeySteps: Array<[string, string, string]> = [
    ...
    ['05', t(language, 'Prepare a citizen packet', 'नागरिक पैकेट तैयार करें'), t(language, 'Only supported, confirmed claims enter the downloadable PDF and machine-readable manifest. The app then hands off to the separate official portal.', 'सिर्फ़ प्रमाणित और पुष्ट दावे ही डाउनलोड होने वाली PDF और मशीन-पठनीय मेनिफ़ेस्ट में जाते हैं। इसके बाद ऐप आपको अलग आधिकारिक पोर्टल पर भेज देता है।')],
  ];
  ...
  const stack: Array<[string, string]> = [
    ...
    ['jsPDF + Web APIs', t(language, 'In-browser PDF/JSON downloads, file hashing, object URLs and speech guidance.', 'ब्राउज़र में ही PDF/JSON डाउनलोड, फ़ाइल हैशिंग, ऑब्जेक्ट URL और आवाज़ मार्गदर्शन।')],
