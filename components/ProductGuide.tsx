...
export function HowItWorksDrawer({ open, onClose, language = 'en' }: { open: boolean; onClose: () => void; language?: Language }) {
  ...
  const scamCards: Array<[string, string]> = [
    [t(language, 'Detect high-risk patterns', 'उच्च जोखिम पैटर्न पहचानें'), t(language, 'Flags APK installation, OTP/PIN requests, personal UPI handles, remote access, urgency, direct-payment pressure, short links and lookalike domains.', 'APK इंस्टॉल, OTP/PIN की माँग, निजी UPI पते, रिमोट एक्सेस, जल्दबाज़ी, सीधे भुगतान का दबाव, छोटे लिंक और नकली पते चिह्नित करता है।')],
